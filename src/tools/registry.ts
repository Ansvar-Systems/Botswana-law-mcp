/**
 * Tool registry for Botswana Law MCP Server.
...
import { getBotswananImplementations, type GetBotswananImplementationsInput } from './get-botswanan-implementations.js';
...
const LIST_SOURCES_TOOL: Tool = {
  ...
  description:
    ...
    'including Botswana Law (National Council for Law Reporting). ' +
    ...
    'Call this FIRST when you need to understand what Botswanan legal data this server covers.',
  inputSchema: { type: 'object', properties: {} },
};
...
export const TOOLS: Tool[] = [
  {
    ...
    description:
      'Search Botswanan statutes and regulations by keyword using full-text search (FTS5 with BM25 ranking). ' +
  ...
  },
  {
    name: 'get_provision',
    description:
      'Retrieve the full text of a specific provision (section/article) from a Botswanan statute. ' +
  ...
  },
  {
    ...
    description:
      'Validate a Botswanan legal citation against the database — zero-hallucination check. ' +
      ...
      'Supports formats: "Section 25, Data Protection Act 2019", "s 25, DPA 2019", "Article 31, Constitution of Botswana 2010".',
    inputSchema: {
      type: 'object',
      properties: {
        citation: {
  ...
  },
  {
    ...
    description:
      'Build a comprehensive set of citations for a legal question by searching across all Botswanan statutes simultaneously. ' +
      'Returns aggregated results from multiple relevant provisions, useful for legal research on a topic. ' +
      'Use this for broad legal questions like "What are the penalties for data breaches in Botswana?" ' +
  ...
  },
  {
    ...
    description:
      'Format a Botswanan legal citation per standard conventions. ' +
  ...
  },
  {
    name: 'check_currency',
    description:
      'Check whether a Botswanan statute or provision is currently in force, amended, repealed, partially suspended, or not yet in force. ' +
  ...
  },
  {
    name: 'get_eu_basis',
    description:
      'Get the EU/international legal basis that a Botswanan statute aligns with or references. ' +
      'Botswana is not an EU member but several Botswanan laws were influenced by EU regulations ' +
    ...
    inputSchema: {
      type: 'object',
      properties: {
        document_id: { type: 'string', description: 'Botswanan statute identifier.' },
        include_articles: {
          type: 'boolean',
  ...
  {
    name: 'get_botswanan_implementations',
    description:
      'Find all Botswanan statutes that align with or implement a specific EU directive or regulation. ' +
      'Given an EU document ID (e.g., "regulation:2016/679" for GDPR), returns matching Botswanan statutes. ' +
      'Note: Botswana implements international standards through domestic legislation influenced by international frameworks.',
    inputSchema: {
      type: 'object',
      properties: {
        eu_document_id: {
  ...
  },
  {
    ...
    description:
      'Search for EU directives and regulations that have Botswanan implementing/aligning legislation. ' +
    ...
    inputSchema: {
      ...
      properties: {
        ...
        has_botswanan_implementation: {
          type: 'boolean',
          description: 'If true, only return EU documents with Botswanan aligning legislation.',
        },
  ...
  },
  {
    ...
    description:
      'Get the EU/international legal basis for a SPECIFIC provision within a Botswanan statute. ' +
  ...
  },
  {
    ...
    description:
      'Check EU/international alignment status for a Botswanan statute or provision. ' +
    ...
    try {
      ...
      switch (name) {
        ...
        case 'get_eu_basis':
          ...
          break;
        case 'get_botswanan_implementations':
          result = await getBotswananImplementations(db, args as unknown as GetBotswananImplementationsInput);
          break;
